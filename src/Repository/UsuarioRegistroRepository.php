...
/**
 * @extends ServiceEntityRepository<UsuarioRegistro>
 *
...
class UsuarioRegistroRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(UsuarioRegistro $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(UsuarioRegistro $entity, bool $flush = true): void
    {
