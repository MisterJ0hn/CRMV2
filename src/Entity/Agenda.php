...
class Agenda
{
     ...
     * @ORM\Column(type="string", length=255, nullable=true)
     */
    private $aderesoTicketId;

    /**
     * @ORM\Column(type="string", length=255, nullable=true)
     */
    private $aderesoStatusCode;

    /**
     * @ORM\Column(type="string", length=255, nullable=true)
     */
    private $aderesoStatusCodeReasignacion;
    ...
    public function setAderesoTicketId(?string $aderesoTicketId):self
    {   
        $this->aderesoTicketId = $aderesoTicketId;
        return $this;
    }
    public function getAderesoTicketId(): ?string
    {   
        return $this->aderesoTicketId ;
        
    }

    public function setAderesoStatusCode(?string $aderesoStatusCode):self
    {
        $this->aderesoStatusCode = $aderesoStatusCode;
        return $this;
    }
    public function getAderesoStatusCode(): ?string
    {
        return $this->aderesoStatusCode;
    }

     public function setAderesoStatusCodeReasignacion(?string $aderesoStatusCodeReasignacion):self
    {
        $this->aderesoStatusCodeReasignacion = $aderesoStatusCodeReasignacion;
        return $this;
    }
    public function getAderesoStatusCodeReasignacion(): ?string
    {
        return $this->aderesoStatusCodeReasignacion;
    }
}
