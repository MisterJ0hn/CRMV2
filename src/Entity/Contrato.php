...
class Contrato
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=ContratoCasetracking::class, mappedBy="contrato")
     */
    ...
    public function __construct()
    {
        ...
        $this->contratoCasetrackings = new ArrayCollection();
    }
   ...
   /**
    ...
    /**
     * @return Collection<int, ContratoCasetracking>
     */
    public function getContratoCasetrackings(): Collection
    {
        return $this->contratoCasetrackings;
    }

    public function addContratoCasetracking(ContratoCasetracking $contratoCasetracking): self
    {
        if (!$this->contratoCasetrackings->contains($contratoCasetracking)) {
            $this->contratoCasetrackings[] = $contratoCasetracking;
            $contratoCasetracking->setContrato($this);
        }

        return $this;
    }

    public function removeContratoCasetracking(ContratoCasetracking $contratoCasetracking): self
    {
        if ($this->contratoCasetrackings->removeElement($contratoCasetracking)) {
            // set the owning side to null (unless already changed)
            if ($contratoCasetracking->getContrato() === $this) {
    ...
    private ?string $materiaNombre=null;
    private ?string $ultimoRecordatorio = null;
    ...
    // --- Propiedades virtuales Mis Clientes --
    private ?string $ritRolCausa = null;
    private ?int $primerPago = null;
    /**
     * @ORM\Column(type="datetime", nullable=true)
     */
    private $fechaUltimaObservacionGeneral;

    /**
     * @ORM\Column(type="integer", nullable=true)
     */
    private $diasMorosidad;
     ...
     * @ORM\Column(type="string", length=255, nullable=true)
     */
    private $materiaOrigen;

    /**
     * @ORM\Column(type="string", length=255, nullable=true)
     */
    private $usuarioUltmaModificacion;
     ...
     * @ORM\Column(type="string", length=255, nullable=true)
     */
    private $companiaOrigen;

    /**
     * @ORM\Column(type="integer", nullable=true)
     */
    private $vigenciaUltAnexo;

    /**
     * @ORM\Column(type="datetime", nullable=true)
     */
    private $fechaCreacionUltAnexo;

    /**
     * @ORM\Column(type="boolean", nullable=true)
     */
    private $suscripcionValidacion;

    /**
     * @ORM\Column(type="boolean", nullable=true)
     */
    private $suscripcionValidacionCallback;
    ...
    public function setEtapas(?string $v): self { $this->etapas = $v; return $this; }

    public function getServicios(): ?string { return $this->servicios; }
    public function setServicios(?string $v): self { $this->servicios = $v; return $this; }

    public function getMateriaNombre(): ?string { return $this->materiaNombre; }
    public function setMateriaNombre(?string $v): self { $this->materiaNombre = $v; return $this; }

    public function getUltimoRecordatorio(): ?string { return $this->ultimoRecordatorio; }
    public function setUltimoRecordatorio(?string $v): self { $this->ultimoRecordatorio = $v; return $this; }

    public function getPrimerPago(): ?int { return $this->primerPago; }
    public function setPrimerPago(?int $v): self { $this->primerPago = $v; return $this; }


    public function getFechaUltimaObservacionGeneral(): ?\DateTimeInterface
    {
        return $this->fechaUltimaObservacionGeneral;
    }

    public function setFechaUltimaObservacionGeneral(?\DateTimeInterface $fechaUltimaObservacionGeneral): self
    {
        $this->fechaUltimaObservacionGeneral = $fechaUltimaObservacionGeneral;

        return $this;
    }

    public function getRitRolCausa(): ?string
    {
        return $this->ritRolCausa;
    }

    public function setRitRolCausa(?string $ritRolCausa): self
    {
        $this->ritRolCausa = $ritRolCausa;

        return $this;
    }

    public function getDiasMorosidad(): ?int
    {
        return $this->diasMorosidad;
    }

    public function setDiasMorosidad(?int $diasMorosidad): self
    {
    ...
    public function getMateriaOrigen(): ?string
    {
        return $this->materiaOrigen;
    }

    public function setMateriaOrigen(?string $materiaOrigen): self
    {
    ...
    public function getUsuarioUltmaModificacion(): ?string
    {
        return $this->usuarioUltmaModificacion;
    }

    public function setUsuarioUltmaModificacion(?string $usuarioUltmaModificacion): self
    {
        $this->usuarioUltmaModificacion = $usuarioUltmaModificacion;
    ...
    public function getCompaniaOrigen(): ?string
    {
        return $this->companiaOrigen;
    }

    public function setCompaniaOrigen(?string $companiaOrigen): self
    {
    ...
    public function getVigenciaUltAnexo(): ?int
    {
        return $this->vigenciaUltAnexo;
    }

    public function setVigenciaUltAnexo(?int $vigenciaUltAnexo): self
    {
        $this->vigenciaUltAnexo = $vigenciaUltAnexo;

        return $this;
    }

    public function getFechaCreacionUltAnexo(): ?\DateTimeInterface
    {
        return $this->fechaCreacionUltAnexo;
    }

    public function setFechaCreacionUltAnexo(?\DateTimeInterface $fechaCreacionUltAnexo): self
    {
        $this->fechaCreacionUltAnexo = $fechaCreacionUltAnexo;

        return $this;
    }

    public function getSuscripcionValidacion(): ?bool
    {
        return $this->suscripcionValidacion;
    }

    public function setSuscripcionValidacion(?bool $suscripcionValidacion): self
    {
        $this->suscripcionValidacion = $suscripcionValidacion;

        return $this;
    }

    public function getSuscripcionValidacionCallback(): ?bool
    {
