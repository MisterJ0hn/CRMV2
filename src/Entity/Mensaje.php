...
class Mensaje
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=MensajePrioridad::class)
     */
    private $mensajePrioridad;
    ...
    public function getMensajePrioridad(): ?MensajePrioridad
    {
        return $this->mensajePrioridad;
    }

    public function setMensajePrioridad(?MensajePrioridad $mensajePrioridad): self
    {
        $this->mensajePrioridad = $mensajePrioridad;
