 ...
 * @Route("/retencion")
 */
class UsuarioRetencionController extends AbstractController
{
    /**
     * @Route("/", name="retencion_index",methods={"GET"})
     */
    ...
    {
        $this->denyAccessUnlessGranted('view','retencion');
        $user=$this->getUser();
        ...
        $pagina=$moduloPerRepository->findOneByName('retencion',$user->getEmpresaActual());
        $query=$usuarioRepository->findByEmpresa($user->getEmpresaActual(),['usuarioTipo'=>14,'estado'=>$modo]);
    ...
    /**
     * @Route("/new", name="retencion_new", methods={"GET","POST"})
     */
    ...
    {
        $this->denyAccessUnlessGranted('create','retencion');
        $user=$this->getUser();
        $pagina=$moduloPerRepository->findOneByName('retencion',$user->getEmpresaActual());
        $usuario = new Usuario();
        $usuario->setEstado(1);
        ...
        $usuario->setUsuarioTipo($usuarioTipoRepository->find(14));
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            try{
                ...
                return $this->redirectToRoute('retencion_index');
            }

            return $this->redirectToRoute('retencion_index');
        }

        return $this->render('retencion/new.html.twig', [
            'usuario' => $usuario,
    ...
    /**
     * @Route("/{id}", name="retencion_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{id}/edit", name="retencion_edit", methods={"GET","POST"})
     */
    ...
    {
        $this->denyAccessUnlessGranted('edit','retencion');
        $user=$this->getUser();
        $pagina=$moduloPerRepository->findOneByName('retencion',$user->getEmpresaActual());
        $empresa=$this->getDoctrine()->getRepository(Empresa::class)->find($user->getEmpresaActual());
    ...
    /**
     * @Route("/{id}", name="retencion_delete", methods={"DELETE"})
     */
