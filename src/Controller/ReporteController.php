...
class ReporteController extends AbstractController
{
    ...
    /**
     * @Route("/anexos", name="reporte_anexos", methods={"GET"})
     */
    public function anexos(
        ...
        $this->denyAccessUnlessGranted('view', 'reporte_anexos');
        $user = $this->getUser();
        $pagina = $moduloPerRepository->findOneByName('reporte_anexos', $user->getEmpresaActual());
        ...
        $query = $contratoAnexoRepository->findUltimosAnexosReporteQuery(
            $user->getEmpresaActual(),
            $filtro,
            $folio,
            $folio ? null : $dateInicio,
            $folio ? null : $dateFin
        );

        $reportes = $paginator->paginate(
            $query,
        ...
        return $this->render('reporte/reporte_anexos.html.twig', [
            'pagina'     => $pagina ? $pagina->getNombre() : 'Reporte Anexos',
            'reportes'   => $reportes,
            'bFiltro'    => $filtro,
            'bFolio'     => $folio,
            'dateInicio' => $dateInicio,
