...
class AnexoController extends AbstractController
{
                            ...
                            Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if($request->request->get('txtFechaTotal')!=null){
                $contrato->setFechaPrimeraCuota(new \DateTime(date($request->request->get('txtFechaTotal'))));
            }
            if($request->request->get('txtFechaAbono')!=null){
                //$contratoAnexo->setFechaPrimerPago(new \DateTime(date($request->request->get('txtFechaAbono'))));
                $contrato->setFechaPrimeraCuota(new \DateTime(date($request->request->get('txtFechaAbono'))));
            }
     ...
     */
    public function pdf(ContratoAnexo $contratoAnexo, ContratoRepository $contratoRepository)
    {
        $this->denyAccessUnlessGranted('view','anexo');
        ...
        $contratoId = $contratoAnexo->getContrato()->getId();
    ...
    public function calularCuotas(ContratoAnexo $contratoAnexo){
        ...
        if($isAbono==true || $isTotal==true){
            ...
            if($isTotal==true){
                ...
                $cuota->setMonto($contratoAnexo->getmontoContrato());
            }else{
                $cuota->setFechaPago($contrato->getFechaPrimeraCuota());
