                ...
                */
                ...
                foreach($subMenus as $submenu){
                    ...
                    if(is_null($submenu->getModulo())){
                        ...
                        $nombre_ruta = $submenu->getModulo()->getRuta();
                       
                        if(in_array($route_name, [$nombre_ruta,$nombre_modulo,$nombre_modulo.'_index', $nombre_modulo.'_show', $nombre_modulo.'_new', $nombre_modulo.'_edit']))
                        {
                            $subitems[$submenu->getNombre()]['class'] = "active";
                            $items[$menu->getNombre()]['open'] = "open";
                        }
                    }
