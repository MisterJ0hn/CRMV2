...
class S3Service
{
     ...
     * @return string|false
     */
    public function subirArchivo(UploadedFile $file, string $carpeta = '')
    {
     ...
     * @return string|false
     */
    public function subirDesdeRuta(string $rutaLocal, string $claveS3, string $contentType = 'application/octet-stream')
    {
        try {
            $resultado = $this->client->putObject([
                'Bucket'      => $this->bucket,
