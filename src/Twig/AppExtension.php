...
use DateTime;
use Proxies\__CG__\App\Entity\EquipoTrabajoVencimiento;
...
class AppExtension extends AbstractExtension
{
    ...
    public function getFunctions(): array
    {
        return [
            ...
            new TwigFunction('montoDeuda',[$this,'montoDeuda']),
             new TwigFunction('montoDeudaPat',[$this,'montoDeudaPat']),
            ...
            new TwigFunction('equipoSegmento',[$this,'equipoSegmento']),
        ];
    }
    ...
    public function montoDeudaPat($contratoId){
        $em=$this->container->get('doctrine');
        ...
        $otros=' c.fechaPago<=now() and DATEDIFF(now(),co.proximoVencimiento)>'.$configuracion->getDiasMorosidadPat();
    ...
    public function equipoSegmento($vencimientoId){
        $em=$this->container->get('doctrine');
        $equipoVencimiento=$em->getRepository(EquipoTrabajoVencimiento::class)->findOneBy(['vencimiento'=>$vencimientoId]);

        if($equipoVencimiento){
            return $equipoVencimiento->getEquipoTrabajo()->getNombre();
        }else{
            return '';
        }
    }
